            ...
            <ul class="navbar-nav me-auto">
              ...
              <li class="nav-item">
                <a class="nav-link fw-medium" href="#landingContact">Contact us</a>
							...
							<li class="nav-item">
                <a class="nav-link fw-medium" href="<?php echo base_url(); ?>demo">Demo</a>
              </li>
            </ul>
          </div>
      ...
      <section id="landingFeatures" class="section-py landing-features">
        <div class="container">
          ...
          <div class="features-icon-wrapper row gx-0 gy-4 g-sm-5">
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
                <img src="<?php echo base_url(); ?>assets/img/front-pages/icons/paper.png" alt="edit" />
              </div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo-1.png"
                              alt="client logo"
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo-2.png"
                              alt="client logo"
                              class="client-logo img-fluid" />
                          </div>
                          <p>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo-3.png"
                              alt="client logo"
                              class="client-logo img-fluid" />
                          </div>
                          <p>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo-4.png"
                              alt="client logo"
                              class="client-logo img-fluid" />
                          </div>
                          <p>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo-5.png"
                              alt="client logo"
                              class="client-logo img-fluid" />
                          </div>
                          <p>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo-6.png"
                              alt="client logo"
                              class="client-logo img-fluid" />
                          </div>
                          <p>
          ...
          <div class="swiper-logo-carousel py-4 my-lg-2">
            <div class="swiper" id="swiper-clients-logos">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img
                    src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo_1-light.png"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo_2-light.png"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo_3-light.png"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo_4-light.png"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="<?php echo base_url(); ?>assets/img/front-pages/branding/logo_5-light.png"
                    alt="client logo"
                    class="client-logo"
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-primary position-relative team-image-box">
                  <img
                    src="<?php echo base_url(); ?>assets/img/front-pages/landing-page/team-member-1.png"
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-info position-relative team-image-box">
                  <img
                    src="<?php echo base_url(); ?>assets/img/front-pages/landing-page/team-member-2.png"
                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                    alt="human image" />
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-danger position-relative team-image-box">
                  <img
                    src="<?php echo base_url(); ?>assets/img/front-pages/landing-page/team-member-3.png"
                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                    alt="human image" />
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-success position-relative team-image-box">
                  <img
                    src="<?php echo base_url(); ?>assets/img/front-pages/landing-page/team-member-4.png"
                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                    alt="human image" />
                </div>
          ...
          <div class="text-center mb-5">
            <div class="position-relative d-inline-block pt-3 pt-md-0">
              ...
              <div class="pricing-plans-item position-absolute d-flex">
                <img
                  src="<?php echo base_url(); ?>assets/img/front-pages/icons/pricing-plans-arrow.png"
          ...
          <div class="row gy-4 pt-lg-3">
              ...
              <div class="card">
                <div class="card-header">
                  <div class="text-center">
                    <img
                      src="<?php echo base_url(); ?>assets/img/front-pages/icons/paper-airplane.png"
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="card border border-primary shadow-lg">
                <div class="card-header">
                  <div class="text-center">
                    <img src="<?php echo base_url(); ?>assets/img/front-pages/icons/plane.png" alt="plane icon" class="mb-4 pb-2" />
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="card">
                <div class="card-header">
                  <div class="text-center">
                    <img
                      src="<?php echo base_url(); ?>assets/img/front-pages/icons/shuttle-rocket.png"
          ...
          <div class="row gy-3">
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-label-primary shadow-none">
                <div class="card-body text-center">
                  <img src="<?php echo base_url(); ?>assets/img/front-pages/icons/laptop.png" alt="laptop" class="mb-2" />
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-label-success shadow-none">
                <div class="card-body text-center">
                  <img src="<?php echo base_url(); ?>assets/img/front-pages/icons/user-success.png" alt="laptop" class="mb-2" />
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-label-info shadow-none">
                <div class="card-body text-center">
                  <img src="<?php echo base_url(); ?>assets/img/front-pages/icons/diamond-info.png" alt="laptop" class="mb-2" />
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-label-warning shadow-none">
                <div class="card-body text-center">
                  <img src="<?php echo base_url(); ?>assets/img/front-pages/icons/check-warning.png" alt="laptop" class="mb-2" />
        ...
        <div class="container">
          ...
          <div class="row gy-5">
            <div class="col-lg-5">
              <div class="text-center">
                <img
                  src="<?php echo base_url(); ?>assets/img/front-pages/landing-page/faq-boy-with-logos.png"
        ...
        <div class="container">
          <div class="row align-items-center gy-5 gy-lg-0">
            ...
            <div class="col-lg-6 pt-lg-5 text-center text-lg-end">
              <img
                src="<?php echo base_url(); ?>assets/img/front-pages/landing-page/cta-dashboard.png"
                alt="cta dashboard"
                class="img-fluid" />
            </div>
          </div>
          ...
          <div class="row gy-4">
            <div class="col-lg-5">
              <div class="contact-img-box position-relative border p-2 h-100">
                <img
                  src="<?php echo base_url(); ?>assets/img/front-pages/landing-page/contact-customer-service.png"
