...
class Preview extends CI_Controller {
	...
	function __construct()
  {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $inviteid = hashids_decrypt($get['PreviewId']);
			...
			$this->Preview_model->insert_comment($comment);
    ...
    $data = array_merge($this->global_data);
		...
		$comment = $this->Preview_model->get_comment($inviteid);
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $inviteid = hashids_decrypt($get['PreviewId']);
			...
			$checkguest = $this->Preview_model->check_guest($inviteid,$get['GuestNumber']);
			...
			if (isset($checkguest)) {
				...
				$this->Preview_model->update_guest($guest);
				...
				$this->Preview_model->insert_guest($guest);
    ...
    $data = array_merge($this->global_data);
		...
		$attend = $this->Preview_model->get_attend($inviteid);
		$notattend = $this->Preview_model->get_not_attend($inviteid);
